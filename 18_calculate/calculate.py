def calculate(operation, a, b, make_int=False, message='The result is'):
    ...
    elif operation == 'add' and make_int == False:
        return f'{message} {a+b}'
    if operation == 'subtract' and make_int == True:
        return f'{message} {int(a-b)}'
    elif operation == 'subtract' and make_int == False:
        return f'{message} {a-b}'
    if operation == 'multiply' and make_int == True:
        return f'{message} {int(a*b)}'
    elif operation == 'multiply' and make_int == False:
        return f'{message} {a*b}'
    if operation == 'divide' and make_int == True:
        return f'{message} {int(a/b)}'
    elif operation == 'divide' and make_int == False:
        return f'{message} {a/b}'
